...
station_not_set(_EventType, {set_station, Station_id}, State) ->
...
station_set(_EventType, {add_value, Reading_type, Reading_value, Date_time}, State) ->
...
station_set(_EventType, {store_data}, State) ->
...
commit_data([], _Station_id, _Monitor) ->
  ok;
commit_data([Reading | Tail], Station_id, Monitor) ->
