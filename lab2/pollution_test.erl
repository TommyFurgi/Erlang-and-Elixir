...
get_maximum_gradient_test() ->
  M = pollution:add_station("Station2", {2,2}, pollution:add_station("Station1", {1,1}, pollution:create_monitor())),
  M1 = pollution:add_value("Station1", {{2023,3,27},{11,16,10}}, "PM10", 10, M),
  M2 = pollution:add_value("Station2", {{2023,3,27},{11,16,11}}, "PM10", 20, M1),
  M3 = pollution:add_station("Station3", {3,3}, M2),

  Expected = [{pollution:get_station("Station1", M3), pollution:get_station("Station2", M3)}],
  Result = pollution:get_maximum_gradient_stations(M3),
